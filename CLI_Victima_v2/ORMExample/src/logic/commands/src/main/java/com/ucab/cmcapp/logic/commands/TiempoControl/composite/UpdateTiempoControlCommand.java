...
public class UpdateTiempoControlCommand extends Command<TiempoControl>
{
    private static Logger _logger = LoggerFactory.getLogger( UpdateTiempoControlCommand.class );
    private TiempoControl _user;
    private TiempoControl _result;
    private UpdateTiempoControlByIdCommand _addTiempoControlCommand;

    public UpdateTiempoControlCommand(TiempoControl user )
    {
    ...
    public void execute()
    {
        ...
        try
        {
            ...
            _addTiempoControlCommand = CommandFactory.createUpdateTiempoControlByIdCommand(_user, getHandler());
