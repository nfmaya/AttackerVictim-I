...
public class CreateZonaSeguridadCommand extends Command<ZonaSeguridad>
{
    ...
    private AddZonaSeguridadCommand _addZonaSeguridadCommand;

    public CreateZonaSeguridadCommand(ZonaSeguridad user )
    {
    ...
    public void execute()
    {
        ...
        try
        {
            ...
            _addZonaSeguridadCommand = CommandFactory.createAddZonaSeguridadCommand(_user, getHandler());
